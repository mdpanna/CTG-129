...
if(isset($_POST['insert'])){
    ...
    }elseif($email!="mdpanna600@gmail.com"){
        $email_error.="<span class='d-block mt-2 alert alert-danger'>Email is not match. $email != mdpanna600@gmail.com</span>";
                ...
                <div class="card ">
                    <div class="card-body">
                        <form action="" method="post">
                            <h4 class="text-center">Form Specific Email Validate</h4>
